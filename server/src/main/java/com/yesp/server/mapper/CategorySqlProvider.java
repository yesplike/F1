...
import com.yesp.server.model.CategoryExample.Criteria;
import com.yesp.server.model.CategoryExample.Criterion;
...
public class CategorySqlProvider {
    ...
    public String insertSelective(Category record) {
        ...
        if (record.getCatno() != null) {
            VALUES("catno", "#{catno,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCatno() != null) {
            SET("catno = #{record.catno,jdbcType=VARCHAR}");
        }
