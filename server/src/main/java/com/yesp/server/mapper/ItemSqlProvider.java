...
import com.yesp.server.model.ItemExample.Criteria;
import com.yesp.server.model.ItemExample.Criterion;
...
public class ItemSqlProvider {
    ...
    public String insertSelective(Item record) {
        ...
        if (record.getItemno() != null) {
            VALUES("itemno", "#{itemno,jdbcType=VARCHAR}");
        }
        ...
        if (record.getListprice() != null) {
            VALUES("listprice", "#{listprice,jdbcType=REAL}");
        }
        
        if (record.getAttrl() != null) {
            VALUES("attrl", "#{attrl,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getListprice() != null) {
            SET("listprice = #{record.listprice,jdbcType=REAL}");
        }
        
        if (record.getAttrl() != null) {
            SET("attrl = #{record.attrl,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Item record) {
        ...
        if (record.getListprice() != null) {
            SET("listprice = #{listprice,jdbcType=REAL}");
        }
        
        if (record.getAttrl() != null) {
            SET("attrl = #{attrl,jdbcType=CHAR}");
        }
